...
func (o *OpportunityService) CreateOpportunity(ctx context.Context, state *models.WorkflowState) error {
	...
	fields := map[string]string{
		...
		"minimum_investment":       strconv.Itoa(utils.RandomInt(1000, 50000)),
		"maximum_investment":       strconv.Itoa(utils.RandomInt(100000, 500000)),
		...
		"distribution":             strconv.Itoa(utils.RandomInt(1, 4)),
		"risk_level":               strconv.Itoa(utils.RandomInt(1, 3)),
		"platform_coverage":        utils.RandomFloat(1.0, 5.0),
		"max_investment_per_retail": strconv.Itoa(utils.RandomInt(50000, 200000)),
		...
		"project_video_url":        utils.RandomURL("youtube"),
	}
